...
import 'package:flutter4test/screens/color_cmd.dart';
...
class _ScanScreenState extends State<ScanScreen> {
  ...
  Future onBtnPressed() async {
    var device = _scanResults
        .where((r) => r.device.platformName.startsWith("ESP"))
        .first
        .device;
    Snackbar.show(ABC.c, "Connect: Success ${device.platformName}", success: true);
    MaterialPageRoute route = MaterialPageRoute(
        builder: (context) => ColorCmdScreen(device: device),
        settings: RouteSettings(name: '/ColorCmd'));
    Navigator.of(context).push(route);
  }
